...
class ViaProcessBase(mp_ctx.Process):
    ...
    def _handle_future_result(self, func, *args):
        ...
        def wait_for_future(func, *args):
            args = [
                arg.result() if isinstance(arg, concurrent.futures.Future) else arg for arg in args
            ]
            return func(*args)
    ...
    def run(self) -> None:
        ...
        self._future_result_tpool = concurrent.futures.ThreadPoolExecutor(max_workers=1)
        torch.cuda.empty_cache()
